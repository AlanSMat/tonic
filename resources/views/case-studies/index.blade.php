...
@section('content')
	...
	<section class="panel section section-cs-intro color-grey" data-color="grey">
		<div class="container-cs">
			...
			<div class="col-2-cs">
				<h4 class="cs-text-intro grid-start2 text-lg">In a market filled with high-budget ads, showcasing the latest and greatest the TV industry can offer, we needed to create a unique experience that puts the customer front and centre of the campaign - highlighting the cinematic experience LG TV offers for their home.</h4>
			</div>
			<div class="col-3-cs">
